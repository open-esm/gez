...
description: The Vue-specific build tool for the Gez framework, providing comprehensive support for Vue 2/3 application building, including component development, SSR rendering, and performance optimization.
head:
  - - meta
    - property: keywords
