...
description: Spezialisiertes Build-Tool des Gez Frameworks für Vue, bietet umfassende Unterstützung für den Aufbau von Vue 2/3-Anwendungen, einschließlich Komponentenentwicklung, SSR-Rendering und Leistungsoptimierung.
head:
  - - meta
    - property: keywords
