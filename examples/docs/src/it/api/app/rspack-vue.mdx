...
description: Lo strumento di costruzione dedicato a Vue per il framework Gez, che fornisce supporto completo per la costruzione di applicazioni Vue 2/3, inclusi lo sviluppo di componenti, il rendering SSR e l'ottimizzazione delle prestazioni.
head:
  - - meta
    - property: keywords
