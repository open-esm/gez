---
titleSuffix: Gez 框架 Vue 建置工具
description: Gez 框架的 Vue 專用建置工具，提供完整的 Vue 2/3 應用程式建置支援，包括元件開發、SSR 渲染和效能最佳化等功能。
head:
  - - meta
    - property: keywords
      content: Gez, Rspack, Vue, Vue2, Vue3, SSR, 建置工具, 元件開發, 伺服器端渲染, 效能最佳化
---
