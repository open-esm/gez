---
titleSuffix: Gez Framework Rspack Bouwgereedschap
description: Het Rspack bouwgereedschap van het Gez framework biedt hoogwaardige applicatiebouwcapaciteiten, ondersteunt de ontwikkeling en bouw van standaardapplicaties en HTML-applicaties, en bevat ingebouwde bronverwerkers en optimalisatieconfiguraties.
head:
  - - meta
    - property: keywords
      content: Gez, Rspack, Bouwgereedschap, Applicatiebouw, HTML-applicatie, TypeScript, CSS, Bronverwerking, Prestatieoptimalisatie
---
...
- `css`: CSS uitvoermethode, opties 'css' (afzonderlijk bestand) of 'style' (inline stijlen)
