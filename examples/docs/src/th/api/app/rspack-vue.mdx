...
- `node`: สร้างโค้ดสำหรับรันในสภาพแวดล้อม Node.js
- `client`: สร้างโค้ดสำหรับรันในสภาพแวดล้อมเบราว์เซอร์
- `server`: สร้างโค้ดสำหรับรันในสภาพแวดล้อมเซิร์ฟเวอร์
...
- `css`: วิธีการส่งออก CSS สามารถเลือก 'css' (ไฟล์แยก) หรือ 'style' (สไตล์อินไลน์)
