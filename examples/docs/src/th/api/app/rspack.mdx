...
description: Rspack build tool ของ Gez framework ให้ความสามารถในการสร้างแอปพลิเคชันที่มีประสิทธิภาพสูง รองรับการพัฒนาและสร้างแอปพลิเคชันมาตรฐานและแอปพลิเคชัน HTML พร้อมด้วยตัวประมวลผลทรัพยากรและการปรับแต่งการปรับให้เหมาะสมที่หลากหลาย
head:
  - - meta
    - property: keywords
