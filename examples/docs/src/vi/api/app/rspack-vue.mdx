...
description: Công cụ xây dựng chuyên dụng cho Vue của Gez Framework, cung cấp hỗ trợ xây dựng ứng dụng Vue 2/3 đầy đủ, bao gồm phát triển component, kết xuất SSR và tối ưu hiệu năng.
head:
  - - meta
    - property: keywords
      content: Gez, Rspack, Vue, Vue2, Vue3, SSR, công cụ xây dựng, phát triển component, kết xuất phía máy chủ, tối ưu hiệu năng
---
