...
description: Gez फ्रेमवर्क के लिए Vue विशिष्ट बिल्ड टूल, जो Vue 2/3 एप्लिकेशन बिल्ड समर्थन प्रदान करता है, जिसमें कंपोनेंट डेवलपमेंट, SSR रेंडरिंग और परफॉर्मेंस ऑप्टिमाइज़ेशन जैसी सुविधाएं शामिल हैं।
head:
  - - meta
    - property: keywords
